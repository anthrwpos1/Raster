...
/*
 * todo
 * 1) разобраться с цветом
 * 2) [пофикшено] гистограммная раскраска
 * 3) многоступенчатая генерация
 * 4) возможность сохранения
 * 5) отдельный класс раскраски, возможно с возможностью задавать
 * 6) псевдо-3д мандельбротка
 *
 * */
